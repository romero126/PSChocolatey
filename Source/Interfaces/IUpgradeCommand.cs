...
namespace PSChoco.Interfaces {
    public class UpgradeCommandConfiguration : CommandConfiguration
    {
        ...
        [CommandHelp("IgnoreDependencies - Ignore dependencies when upgrading package(s). Defaults to false.")]
        ...
        [CommandAlias("failonunfound", "fail-on-unfound")]
        [CommandHelp("Fail On Unfound Packages - If a package is not found in sources specified, fail instead of warn.")]
        public bool FailOnUnfound;
        ...
        [CommandAlias("failonnotinstalled", "fail-on-not-installed")]
        [CommandHelp("Fail On Non-installed Packages - If a package is not already installed, fail instead of installing.")]
        public bool FailOnNotInstalled;
        ...
        [CommandAlias("except")]
        [CommandHelp("Except - a comma-separated list of package names that should not be upgraded when upgrading 'all'. Defaults to empty. Available in 0.9.10+.")]
        ...
        [CommandAlias("skip-if-not-installed", "only-upgrade-installed", "skip-when-not-installed")]
        [CommandHelp("Skip Packages Not Installed - if a package is not installed, do not install it during the upgrade process. Overrides the default feature 'skipPackageUpgradesWhenNotInstalled' set to 'False'. Available in 0.10.12+.")]
        public bool SkipWhenNotInstalled;

        [CommandAlias("install-if-not-installed")]
        [CommandHelp("Install Missing Packages When Not Installed - if a package is not installed, install it as part of running upgrade (typically default behavior). Overrides the default feature 'skipPackageUpgradesWhenNotInstalled' set to 'False'. Available in 0.10.12+.")]
        public bool InstallIfNotInstalled;

        [CommandAlias("exclude-pre", "exclude-prerelease", "exclude-prereleases")]
        [CommandHelp("Exclude Prerelease - Should prerelease be ignored for upgrades? Will be ignored if you pass `--pre`. Available in 0.10.4+.")]
        public bool ExcludePrereleases;

        [CommandAlias("userememberedargs", "userememberedarguments", "userememberedoptions", "use-remembered-args", "use-remembered-arguments", "use-remembered-options")]
        [CommandHelp("Use Remembered Options for Upgrade - use the arguments and options used during install for upgrade. Does not override arguments being passed at runtime. Overrides the default feature 'useRememberedArgumentsForUpgrades' set to 'False'. Available in 0.10.4+.")]
        public bool UseRememberedOptions;

        [CommandAlias("ignorerememberedargs", "ignorerememberedarguments", "ignorerememberedoptions", "ignore-remembered-args", "ignore-remembered-arguments", "ignore-remembered-options")]
        [CommandHelp("Ignore Remembered Options for Upgrade - ignore the arguments and options used during install for upgrade. Overrides the default feature 'useRememberedArgumentsForUpgrades' set to 'False'. Available in 0.10.4+.")]
        public bool IgnoreRememberedOptions;
